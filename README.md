...
In [Dataspecer](https://dataspecer.com), you can use the "Import" functionality with the spec URL, e.g. `https://mff-uk.github.io/specifications/dcat-ap`, to see/edit the spec in editor.
